...
class P3KSeeder extends Seeder
{
    ...
    public function run(): void
    {
        ...
        DB::table('p3k')->insert([
            ...
            ['kotak_p3k_id' => 1, 'barang_id' => 8, 'jumlah' => 5 , 'created_at' => now(), 'updated_at' => now()],
            ['kotak_p3k_id' => 1, 'barang_id' => 9, 'jumlah' => 5 , 'created_at' => now(), 'updated_at' => now()],
            ...
            ['kotak_p3k_id' => 2, 'barang_id' => 8, 'jumlah' => 3 , 'created_at' => now(), 'updated_at' => now()],
            ['kotak_p3k_id' => 2, 'barang_id' => 9, 'jumlah' => 3 , 'created_at' => now(), 'updated_at' => now()],
            ['kotak_p3k_id' => 2, 'barang_id' => 10, 'jumlah' => 3 , 'created_at' => now(), 'updated_at' => now()],
            ['kotak_p3k_id' => 2, 'barang_id' => 11, 'jumlah' => 3 , 'created_at' => now(), 'updated_at' => now()],
            ...
            ['kotak_p3k_id' => 2, 'barang_id' => 15, 'jumlah' => 3 , 'created_at' => now(), 'updated_at' => now()],
